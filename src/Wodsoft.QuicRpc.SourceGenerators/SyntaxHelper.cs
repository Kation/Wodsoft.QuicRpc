    ...
    public static class SyntaxHelper
    {
        public static bool IsSameFullName(TypeSyntax nameSyntax, string fullname, bool isAttribute)
        {
            ...
            else if (nameSyntax is IdentifierNameSyntax identifierName)
            {
                ...
                return GuessName(identifierName, name, fullname, isAttribute);
            }
            ...
            {
                var name = genericNameSyntax.Identifier.ValueText;
                return GuessName(genericNameSyntax, name, fullname, isAttribute);
            }
            return false;
        }

        private static bool GuessName(NameSyntax nameSyntax, string name, string fullname, bool isAttribute)
        {
        ...
        public static bool IsSameFullName(SyntaxNode syntaxNode, string fullName, SemanticModel model)
        {
        ...
        public static bool IsSameFullName(ITypeSymbol typeSymbol, string fullName)
        {
            return typeSymbol.ContainingNamespace + "." + typeSymbol.Name == fullName;
        }
    }
}
